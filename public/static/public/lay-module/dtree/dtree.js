    ...
    DTree.prototype.getMenubarToolDom = function(menu){
        ...
        switch (menu) {
            ...
            case defaultMenu.remove:
                ...
                break;
            case defaultMenu.searchNode:
                _this.toolbarMenu[defaultMenu.searchNode] = _this.setToolbarDom().setMenuToolbarOption(defaultMenu.searchNode, _this.toolbarStyle.title, _this.usefontStyle.toolbar.menubar.search, "查询");
                break;
        }
    };
