...
layui.define(["element", "layer", "jquery"], function (exports) {
    ...
    var miniTab = {
        ...
        render: function (options) {
            ...
            if( cache != "false" ){
                var layuiminiTab = layui.data(localStorageName)['layuiminiTab'];
                if( layuiminiTab == undefined ){
                    layuiminiTab = [];
                }
                for( var i = 0; i < layuiminiTab.length; i++ ){
                    miniTab.create(layuiminiTab[i]);
                }  
            }
        },
        ...
        create: function (options) {
            ...
            options.maxTabNum = options.maxTabNum || 20;
            options.is_add = options.is_add == false?false:true;
            ...
            if( cache != "false"){
                ...
                var is = 1;
                for( var i = 0; i < layuiminiTab.length; i++ ){
                    if( layuiminiTab[i]['tabId'] == options.tabId ){
                        is = 2;
                    }
                }         
                if( is == 1 ){
        ...
        delete: function (tabId, isParent) {
            ...
            for( var i = 0; i < layuiminiTab.length; i++ ){
                if( layuiminiTab[i]['tabId'] == tabId ){
                    layuiminiTab.splice(i,1);
                }
            }  
            layui.data(localStorageName, {
                key: 'layuiminiTab'
