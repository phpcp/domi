layui.use(['form','table','unit_call'], function () {
    ...
    unit_call.delPower('.AddTo','wcountryz.add');
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'name', title: '国家名称',  edit:'text',align:'center', width:200},
            {field: 'code', title: '国家代号', edit:'text', align:'center', width:200},
    ...
    form.on('switch(filter)', function(data){
        ...
        unit_call.ChangeState('wcountryzs','status',status,'id',data.elem.id,function(res){
            layer.msg(res.msg);
    ...
    table.on('edit(List)', function(obj){ 
    	if(obj.data.form == false ){
	        ...
	        unit_call.ChangeState('wcountryzs',obj.field,obj.value,'id',obj.data.id,function(res){
	            layer.msg(res.msg);
	            if( res.code == 0 ){table.reload("ListId",{done: done})} 
	        });
    	}
