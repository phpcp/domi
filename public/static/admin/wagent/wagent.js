layui.use(['form','table','unit_call'], function () {
    ...
    unit_call.delPower('.AddTo','wagent.add');
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'name', title: '代理商名称',  edit:'text',align:'center', width:200},
    ...
    form.on('switch(filter)', function(data){
        ...
        unit_call.ChangeState('wagents','status',status,'id',data.elem.id,function(res){
            layer.msg(res.msg);
    ...
    table.on('edit(List)', function(obj){ 
    	if(obj.data.form == false ){
	        ...
	        unit_call.ChangeState('wagents',obj.field,obj.value,'id',obj.data.id,function(res){
	            layer.msg(res.msg);
	            if( res.code == 0 ){table.reload("ListId",{done: done})} 
	        });
    	}
