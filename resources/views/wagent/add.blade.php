...
<html lang="en">
    ...
    <body style="margin: 15px 15px 15px 15px;background: #f2f2f2;">
		<div class="layui-form"   url="wagent-form" sign="wagent.form" >
		    <div class="ELEMENT" style="width:80%;height: calc(100vh - 90px);">
	           
				<div class="layui-form-item ">
	                <label class="layui-form-label">代理商名称</label>
	                <div class="layui-input-block">
	                    <input type="text" name="name" autocomplete="off" class="layui-input layext-text-tool "   placeholder="请输入代理商名称" maxlength="50" lay-verify="noNull" name-verify="代理商名称">
	                </div>
	            </div>
	            <div class="layui-form-item ">
...
<script src="/static/admin/wagent/wagent_add.js"></script>
