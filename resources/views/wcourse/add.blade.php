...
<html lang="en">
    ...
    <body style="margin: 15px 15px 15px 15px;background: #f2f2f2;">
		<div class="layui-form"   url="wcourse-form" sign="wcourse.form" >
		    <div class="ELEMENT" style="width:80%;height: calc(100vh - 90px);">
		        <div class="layui-form-item">
	                <label class="layui-form-label">课程主图</label>
	                <div class="layui-input-block singleImage" name="course_img" width="150px" border_remarks="20px" verify="noNull" mark="course_img" nameVerify="课程主图"  >
	            ...
	            <div class="layui-form-item ">
	                ...
	                <div class="layui-input-block " >
	                    <input type="radio" name="type" value="1" title="直播技巧" checked>
...
<script src="/static/admin/wcourse/wcourse_add.js"></script>
